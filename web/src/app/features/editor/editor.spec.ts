...
const doc: DocumentFull = {
  ...
  space_id: '01J00000000000000000000001',
  folder_id: null,
  title: 'Refunds',
  doc_type: 'sop',
  state: 'draft',
  ...
  created_at: '',
  content: { version: 1, purpose: '', scope: '', prerequisites: [], outcome: '', blocks: [] },
  steps: [],
};
...
describe('Editor submit blockers', () => {
  it('names what is missing before submit', async () => {
    ...
    expect(fixture.componentInstance.submitBlockers()).toEqual([
      'at least one step',
      'a purpose',
      'an owner',
    ]);
