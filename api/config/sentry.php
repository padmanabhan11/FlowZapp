...
return [
    ...
    // M4-T1: release = git commit. CD sets SENTRY_RELEASE on the App Platform spec from GITHUB_SHA; locally it falls back to the checkout.
    'release' => env('SENTRY_RELEASE') ?: (is_file(base_path('.release')) ? trim((string) file_get_contents(base_path('.release'))) : null),
